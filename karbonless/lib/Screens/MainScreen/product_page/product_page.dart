...
import 'package:flutter_auth/Screens/MainScreen/product_page/product_details.dart';
              ...
              child: TextButton(
                ...
                onPressed: () async {
                  ...
                  Future<List<ProductDetails>> fetchProducts() async {
                    ...
                    request.files.add(
                        await http.MultipartFile.fromPath('input', image.path));
                    var response = await request.send();
                    var responseBody = await response.stream.bytesToString();
                    debugPrint(responseBody);
                    final productDetails = productDetailsFromJson(responseBody);
